...
async def source(e):
    ...
    await edit_or_reply(
        e,
        "Click [here](https://github.com/MarshallCares/SpotifyDL) to open this bot source code\
        \nClick [here](https://github.com/llawllet/DazaiPack) to open supported link for heroku/railway",
    )
